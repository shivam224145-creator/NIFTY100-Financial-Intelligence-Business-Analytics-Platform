...
- `book_value_per_share` was not implemented because `shares_outstanding` data was unavailable in the source datasets.
...
Data Analytics | Data Engineering | Business Intelligence | Data Science
